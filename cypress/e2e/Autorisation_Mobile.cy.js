describe('Autorisation', function (){
    ...
    it('Autorisation', function () {
        ...
        cy.get('button[class="sc-evZas gLjLbw MuiButtonBase-root sc-dIouRR dhumOf MuiButton-root MuiButton-contained MuiButton-containedPrimary MuiButton-sizeMedium MuiButton-containedSizeMedium"]',{timeout: 30000}).should('be.visible').click()
